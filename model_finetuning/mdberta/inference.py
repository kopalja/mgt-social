...
if __name__ == "__main__":
    ...
    parser.add_argument('--base_model', default="mdberta/models/best", type=str)
    parser.add_argument('--model_path', default="mdberta/models/best", type=str)
    parser.add_argument("--demo_dataset", default=True, action=argparse.BooleanOptionalAction)
    parser.add_argument("--batch_size", default=1, type=int)
    args = parser.parse_args()

    tokenizer = AutoTokenizer.from_pretrained(args.base_model)
    tokenized_train = DemoDataset(tokenizer, is_instruction=False, size=100)
